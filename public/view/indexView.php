    ...
    <div class="page-container">
                ...
                <div class="header__cols">
                    <div class="header__left">
                        <div class="header__cols">
                            ...
                            <div class="header__col">
                                <a class="logo" href="#">
                                    <img class="logo__image" src="media/img/logo/logo_uniformate.jpg" alt="">
                                </a>
                            </div>
        ...
        <main class="main">              
                        ...
                        <div class="first-screen__mob-col">
                            <ul class="first-screen__socials side-socials">
                                <li class="side-socials__item">
                                    <a class="side-socials__link" href="#">FB</a>
                                </li>
                                <li class="side-socials__item">
                                    <a class="side-socials__link" href="#">TW</a>
                                </li>   
                                <li class="side-socials__item">
                                    <a class="side-socials__link" href="#">INS</a>
                                </li>
                                <li class="side-socials__item">
                                    <a class="side-socials__link" href="#">PT</a>
                                </li>
                            </ul>                        
                        </div>
                ...
                <div class="first-screen__center">
                    <div class="main-slider">
                                        ...
                                        <div class="main-slider__row">
                                            <div class="main-slider__cell">
                                                <div class="main-slider__content">
                                                    ...
                                                    <h2 class="main-slider__title">meet New <br>Fashion week</h2>
                                                    <a class="main-slider__button button" href="shop.html">
                                                        <span class="button__text">Shop now</span>
                                                    </a>
                                                </div>
                                                <div class="main-slider__image-wrap">
                                                    <div class="main-slider__image" data-bg="https://images.unsplash.com/photo-1523381294911-8d3cead13475?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="main-slider__max">
                                        <div class="main-slider__row">
                                            <div class="main-slider__cell">
                                                ...
                                                <div class="main-slider__image-wrap">
                                                    <div class="main-slider__image" data-bg="https://images.unsplash.com/photo-1479064555552-3ef4979f8908?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="main-slider__max">
                                        <div class="main-slider__row">
                                            <div class="main-slider__cell">
                                                ...
                                                <div class="main-slider__image-wrap">
                                                    <div class="main-slider__image" data-bg="https://images.unsplash.com/photo-1543087903-1ac2ec7aa8c5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="main-slider__bg-wrap">
                            <img class="main-slider__bg" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-first-screen.svg" alt="">
                    ...
                    <div class="collections">
                        ...
                        <article class="collection collection_1">
                            <div class="collection__all">
                                <div class="collection__mob-image">
                                    <a class="collection__image" data-bg="https://via.placeholder.com/427x560" href="#"></a>
                                    <span class="collection__category">accessories</span>  
                                </div>
                                <div class="collection__row">
                                    <div class="collection__cell">
                                        <div class="collection__content">
                                            <span class="collection__subtitle category-subtitle"><b>new</b> accessories</span>
                                            <h4 class="collection__title">Fashion for <br>this summer</h4>
                                            <a class="collection__more read-more" href="shop.html">Shop now</a>
                                        </div>
                                    </div>
                                </div> 
                        ...
                        <article class="season-sale">
                            <div class="season-sale__all">
                                <div class="season-sale__image" data-bg="https://via.placeholder.com/488x560"></div>
                                <div class="season-sale__row">
                                    <div class="season-sale__cell">
                                        <div class="season-sale__content">
                                            <h4 class="season-sale__title">season <span>sale</span></h4>
                                            <p class="season-sale__text">Non aliqua reprehenderit reprehenderit culpa laboris nulla</p>
                                            <a class="season-sale__more read-more" href="shop.html">Shop now</a>
                                        </div>
                                    </div>
                                </div>    
                        ...
                        <article class="collection collection_2">
                            <div class="collection__all">
                                ...
                                <div class="collection__row">
                                    <div class="collection__cell">
                                        <div class="collection__content">
                                            <span class="collection__subtitle category-subtitle"><b>men</b> collection</span>
                                            <h4 class="collection__title">new Autumn <br>arrivals 2020</h4>
                                            <a class="collection__more read-more" href="shop.html">Shop now</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <article class="collection collection_3">
                            <div class="collection__all">
                                <div class="collection__mob-image">
                                    <a class="collection__image" data-bg="https://via.placeholder.com/427x560" href="#"></a>
                                    <span class="collection__category">dresses</span>   
                                </div>
                                <div class="collection__row">
                                    <div class="collection__cell">
                                        <div class="collection__content">
                                            <span class="collection__subtitle category-subtitle"><b>women</b> collection</span>
                                            <h4 class="collection__title">Trendy look <br>for every day</h4>
                                            <a class="collection__more read-more" href="shop.html">Shop now</a>
                                        </div>
                                    </div>
                                </div> 
                        ...
                        <div class="collections__bottom">
                            <div class="collections__max">
                                <h3 class="collection-title">
                                    <span class="collection-title__count">5649</span>
                                    <span class="collection-title__plus">+</span>
                                    <span class="collection-title__text">Satisfied clients</span>
                                </h3>      
                            </div>                      
                        </div>
                    </div> 
                    <div class="load-more">
                        <a class="button" href="collections.html">
                            <span class="button__text">View all collections</span>
                        </a>
                    </div>                                     
                </div>                  
                <img class="collection-block__bg-left" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-collections.svg" alt="">
                <img class="collection-block__bg-right" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-collections.svg" alt="">
            </section>
            <!-- COLLECTION END -->
                ...
                <div class="products-nav tabs-nav js-line">
                    <ul class="tabs-nav__list">
                        <li class="tabs-nav__item js-tabs-item js-line-item active">
                            <a class="tabs-nav__link js-line-link js-tabs-link" href="#products-1">All</a>
                        </li>
                        <li class="tabs-nav__item js-line-item js-tabs-item">
                            <a class="tabs-nav__link js-line-link js-tabs-link" href="#products-2">Men</a>
                        </li>
                        <li class="tabs-nav__item js-line-item js-tabs-item">
                            <a class="tabs-nav__link js-line-link js-tabs-link" href="#products-3">Women</a>
                        </li>
                        <li class="tabs-nav__item js-line-item js-tabs-item">
                            <a class="tabs-nav__link js-line-link js-tabs-link" href="#products-4">Accessories</a>
                        </li>
                        <li class="tabs-nav__item js-line-item js-tabs-item">
                            <a class="tabs-nav__link js-line-link js-tabs-link" href="#products-5">New arrivals</a>
                        </li>
                    </ul>
                            ...
                            <article class="short-item">
                                <div class="short-item__all">
                                    <a class="short-item__image-bg" href="product_page.html">
                                        <img class="short-item__image" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="https://via.placeholder.com/262x360" alt="">
                                    </a>
                                    ...
                                    <h4 class="short-item__title">
                                        <a class="short-item__link" href="product_page.html">Cotton T-shirt</a>
                                    </h4>
                                    <span class="short-item__price">$35.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <h4 class="short-item__title">
                                        <a class="short-item__link" href="product_page.html">Textured turtleneck with zip</a>
                                    </h4>
                                    <span class="short-item__price">$25.99</span>
                                    <span class="short-item__old-price">$52.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <h4 class="short-item__title">
                                        <a class="short-item__link" href="product_page.html">Spray wrap skirt</a>
                                    </h4>
                                    <span class="short-item__price">$29.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <span class="short-item__price">$63.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <span class="short-item__price">$47.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <span class="short-item__price">$38.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <h4 class="short-item__title">
                                        <a class="short-item__link" href="product_page.html">Retro style handbag</a>
                                    </h4>
                                    <span class="short-item__price">$98.99</span>
                                    <span class="short-item__old-price">$52.99</span>
                                </div>
                            </article>
                            <article class="short-item">
                                <div class="short-item__all">
                                    ...
                                    <h4 class="short-item__title">
                                        <a class="short-item__link" href="product_page.html">Long oversized T-shirt</a>
                                    </h4>
                                    <span class="short-item__price">$15.99</span>
                                    <span class="short-item__old-price">$52.99</span>
                                </div>
                            </article>                            
                        </div>
                        <img class="main-catalog__bg" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-catalog.svg" alt="">
                    </div>
                </div>
                <!-- TAB 1 END -->
            ...
            <section class="deal-block">
                <div class="deal-block__cols">
                    <div class="deal-block__col">
                        <div class="deal-block__image" data-bg="https://via.placeholder.com/1040x800"></div>
                        <div class="deal-block__content">
                            <div class="deal-block__row">
                                <div class="deal-block__cell">
                                    ...
                                    <h3 class="deal-block__title">Stay warm <br>and trendy</h3>
                                    <div class="timer js-timer"></div>
                                    <a class="deal-block__button button" href="shop.html">
                                        <span class="button__text">Shop now</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <img class="deal-block__bg" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-deal.svg" alt="">
                    </div>
                </div>
            </section>
                    ...
                    <article class="advantage">
                        <div class="advantage__content">
                            <div class="advantage__icon-wrap">
                                <img class="advantage__icon" src="https://via.placeholder.com/70x70" alt="">
                            </div>
                        ...
                        <img class="advantage__bg" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-advantages.svg" alt="">
                    </article>
                    <article class="advantage">
                        <div class="advantage__content">
                            <div class="advantage__icon-wrap">
                                <img class="advantage__icon" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="https://via.placeholder.com/70x70" alt="">
                            </div>
            ...
            <section class="main-block wrapper">
                ...
                <div class="catalog-slider js-catalog loaded">
                    <div class="catalog-slider__list-wrap">
                        <div class="catalog-slider__list js-catalog-carousel">
                            <article class="short-item">
                                <div class="short-item__all">
                                    <a class="short-item__image-bg" href="product_page.html">
                                        <img class="short-item__image" src="https://via.placeholder.com/262x360" alt="">
                                    </a>
                                    <div class="short-item__top">
                                        <div class="short-item__cols">
                                            <div class="short-item__col">
                    ...
                    <div class="load-icon"></div>
                    <img class="catalog-slider__bg" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-catalog.svg" alt="">
                </div>
            </section>
            <!-- BEST SELLERS END -->
        ...
        <footer class="footer">      
            <div class="footer__main wrapper">
                ...
                <img class="footer__bg-left" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-footer-left.svg" alt="">
                <img class="footer__bg-right" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-lazy="media/img/svg/vector-footer-right.svg" alt="">
            </div>
        </footer>
        <!-- FOOTER END -->    
