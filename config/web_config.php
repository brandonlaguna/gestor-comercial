...
?>
    ...
    <link rel="stylesheet" type="text/css" href="css/bracket.min.css">
    <link rel="stylesheet" type="text/css" href="css/styles.css">
    <link rel="stylesheet" type="text/css" href="lib/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="lib/ionicons/css/ionicons.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="lib/rickshaw/rickshaw.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="lib/spinkit/css/spinkit.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="lib/timepicker/jquery.timepicker.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="lib/perfect-scrollbar/perfect-scrollbar.css">
    <link rel="stylesheet" type="text/css" href="lib/infinite-bar/infinite.css">
    ...
    <link rel="stylesheet" type="text/css" href="lib/totast/src/jquery.toast.css">
    <!-- Bracket CSS -->
</head>
