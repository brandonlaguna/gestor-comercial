...
class DetalleIngresoContable extends EntidadBase{
    ...
    public function addArticulos()
    {
        ...
        if($filter->num_rows > 0){
            ...
            $query="INSERT INTO detalle_ingreso_contable (dic_id_trans, dic_seq_detalle, dic_cta_item_det,dic_det_item_det,dic_cant_item_det, dic_ter_item_det, dic_ccos_item_det, dic_d_c_item_det, dic_valor_item, dic_base_ret_item, dic_fecha_vcto_item, dic_dato_fact_prove)
            VALUES(
    	        '".$this->dic_id_trans."',
