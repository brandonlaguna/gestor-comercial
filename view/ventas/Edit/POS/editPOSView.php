          ...
          <form id="formVenta" finish="" class="">
              ...
              <div class="row">
                  ...
                  <div class="">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control fc-datepicker" name="end_date" placeholder="MM/DD/YYYY" value="<?=get_date_format_calendar($venta->fecha_final,"-")?>" autocomplete="off">
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="observaciones" value="<?=$venta->observaciones?>" id="observaciones" placeholder="Observacines" autocomplete="off">
                  </div>
                </div>
          ...
          <div class="br-section-wrapper">
              ...
              <div class="infinite-linear"></div>
                  ...
                  <div class="row mt-5 mb-4">
                    ...
                    <div class="col-sm-12 col-md-8"><button class="btn btn-oblong btn-success modal-effect" data-effect="effect-just-me" id="updateVenta" style="width:100%;">Enviar</button></div>
                  </div>    
...
<script>
      $(function(){
        ...
        //iniciar funcion que carga los metodos depago y los impuestos usados
        loadCart();
        loadMetodoPago();
      });
    </script>
