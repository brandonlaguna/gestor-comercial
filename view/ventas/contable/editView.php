...
<div class="br-pagetitle"></div>
    <div class="br-pagebody">
        ...
        <form id="formVenta" finish="" class="form-layout form-layout-1">
            ...
            <input type="hidden" name="idventa" value="<?=$venta->cc_id_transa?>">
            ...
            <div class="col-sm-12 col-lg-6">
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control codigo_contable" type="text" name="proveedor" value="<?=$venta->documento_proveedor." - ".$venta->nombre_tercero?>" id="proveedor" onclick="autocomplete()" placeholder="Ingresa Nombre o documento del cliente">
                </div>
              </div>
                ...
                <div class="form-group">
                  <label class="form-control-label">Comprobante: <span class="tx-danger">*</span></label>
                    <select class="form-control select2" data-placeholder="" id="detalleComprobante" name="comprobante">
                      <option value="<?=$venta->iddetalle_documento_sucursal?>" selected><?=$venta->ultima_serie."-".zero_fill($venta->ultimo_numero,8)?></option>
                    </select>
                </div>
              </div>
              ...
              <div class="col-sm-12 col-lg-4">
                <div class="form-group">
                  ...
                  <optgroup label="Seleccionado">
                    <option value="<?=$venta->fp_id?>"><?=$venta->fp_nombre?></option>
                  </optgroup>
  ...
  <div class="card shadow p-1 bg-white rounded">
        ...
        <tr>
            ...
            <!-- <td><input class="form-control calculate" type="text" name="imp_venta" id="imp_venta"></td> -->
            <td>
      ...
      <div class="row mt-5">
        ...
        <div class="container-fluid ">
            <div class="row mt-5 mb-4">
                <div class="col-sm-12 col-md-4"><a href="#ventas/reg_contable" class="btn btn-oblong btn-outline-danger" style="width:100%;">Regresar</a ></div>
