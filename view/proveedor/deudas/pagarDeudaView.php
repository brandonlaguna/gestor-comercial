              ...
              <div class="modal-content tx-size-sm">
                ...
                <div class="modal-header pd-x-20">
                  ...
                  <form id="formInfoPago">
                    <input type="hidden" name="id_credito_proveedor" value="<?=$credito->idcredito_proveedor?>">
                  </form>
                ...
                <div class="modal-footer">
                  <button data-dismiss="modal" type="button" class="btn btn-primary tx-size-xs sendForm" id="send" disabled>Save changes</button>
...
<script src="controller/script/ProveedorController.js"></script>
