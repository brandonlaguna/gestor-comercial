...
<div class="row">
    <div class="col-sm-12 text-center ">
        ...
        <div class="change"><p style="background:white;" >Método de pago: <strong><?=$metodopago->mp_nombre?></strong></p></div>
            ...
            <input type="hidden" name="tipo_pago" value="<?=$metodopago->mp_id?>">
