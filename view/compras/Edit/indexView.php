            ...
            <div class="col-sm-12 col-lg-6">
              ...
              <div class="col-sm-12 col-lg-4">
                <div class="form-group">
                  ...
                  <option value="<?=$compra->fp_id?>"><?=$compra->tipo_pago?></option>
                  </optgroup>
  ...
  <div class="card shadow p-1 bg-white rounded">
        ...
        <tbody>
          <tr>
            ...
            <td>
            <input type="hidden" name="codigo_contable" id="codigo_contable" class="codigo_contable">
      ...
      <div class="row mt-5">
        ...
        <div class="container-fluid ">
            <div class="row mt-5 mb-4">
                ...
                <div class="col-sm-12 col-md-8"><button class="btn btn-oblong btn-success" id="updateCompra" style="width:100%;">Guardar Cambios</button></div>
            </div>
        </div>
    </div>
