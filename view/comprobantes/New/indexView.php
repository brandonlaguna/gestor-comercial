...
<div id="modaldemo3" class="modal fade">
    ...
    <div class="br-pagebody">
        ...
        <form id="formCompra" finish="" class="form-layout form-layout-1">
            ...
            <input type="hidden" name="contabilidad" id="contabilidad" value="">
            ...
            <div class="col-sm-12 col-lg-6">
              ...
              <div class="wd-200 mg-b-30">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control fc-datepicker" name="start_date" placeholder="MM/DD/YYYY" value="<?=date("m/d/Y")?>" readonly>
                </div>
              </div>
              </div>
                ...
                <label class="form-control-label">Fecha Final: <span class="tx-danger">*</span></label>
                  <div class="wd-200">
                    <div class="input-group">
                      ...
                      <input type="text" autocomplete="off" class="form-control fc-datepicker" name="end_date" placeholder="MM/DD/YYYY" value="00/00/0000" readonly>
                    </div>
                  </div>
              </div>
