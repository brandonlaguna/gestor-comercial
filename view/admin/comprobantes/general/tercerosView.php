    ...
    <div class="row mg-b-25">
            <div class="col-sm-12 col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Cliente/Proveedor: <span class="tx-danger">*</span></label>
                  <input type="hidden" name="pos" id="pos" value="<?=$pos?>">
                  <input type="hidden" name="control" id="control" value="<?=$control?>">
                  <select name="idpersona" id="" class="form-control select2-show-search filter">
                        <?php foreach ($personas as $persona) { ?>
                            <option value="<?=$persona->idpersona?>"><?=$persona->nombre_persona." - ".$persona->nombre." ".$persona->num_documento." <span style='font-size:3pt;'>(".$persona->tipo_persona.")</span>"?></option>
                        <?php }?>
                  </select>
                </div>
            </div>
