        ...
        <form id="save_formapago" finish="admin/save_formapago">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="fp_nombre" value="" autocomplete="off" placeholder="Nombre">
                </div>
              </div><!-- col-12 -->
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="fp_descripcion" value="" autocomplete="off" placeholder="Descripcion">
                </div>
              </div><!-- col-12 -->
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="codigo_contableby" attr="<?=$attr?>" param="<?=$param?>" name="fp_cuenta_contable" value="" autocomplete="off" placeholder="Cuenta Contable">
                </div>
              </div><!-- col-12 -->
