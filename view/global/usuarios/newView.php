...
<form id="save_empleado" finish="usuarios/save_empleado">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="apellidos" value="" placeholder="Apellidos">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="num_documento" value="" placeholder="Pais">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Fecha Nacimiento: <span class="tx-danger">*</span></label>
                  <input id="dateMask" type="text" class="form-control" value="" placeholder="YYYY-MM-DD" name="fecha_nacimiento">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Direccion: <span class="tx-danger">*</span></label>
                  <input id="dateMask" type="text" name="direccion"class="form-control" value="" placeholder="Direccion">
                </div>
              </div><!-- col-4 -->
            ...
            <div class="form-layout-footer">
              <button class="btn btn-info" id="send" onclick="sendForm('save_empleado')">Guardar</button>
