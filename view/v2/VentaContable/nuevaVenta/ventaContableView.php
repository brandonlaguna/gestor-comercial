                ...
                <div class="col-sm-11 col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="form-control codigo_contable" type="text" name="proveedor" value="" id="proveedor"
                            onclick="autocomplete()" placeholder="Ingresa Nombre o documento del cliente"
                            autocomplete="off">
                    </div>
                </div>
                    ...
                    <div class="wd-200 mg-b-30">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control fc-datepicker" name="start_date"
                                placeholder="MM/DD/YYYY" value="<?=date("m/d/Y")?>" autocomplete="off" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wd-200">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control flatpickr" name="end_date"
                                placeholder="MM/DD/YYYY" value="" autocomplete="off" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="table" id="ItemsToAdd">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input class="form-control calculate" type="text" name="precio_venta" id="precio_venta">
                        </td>
                        <!-- <td><input class="form-control calculate" type="text" name="imp_venta" id="imp_venta" disabled></td> -->
                        <td>
                            <div class="input-append btn-group">
                                <input class="span2 form-control calculate" name="imp_venta" id="imp_venta" type="text"
                                    readonly>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <p class="dropdown-item change_tax" style="margin:0"
                                        onclick="changeTax('imp_venta','<?=$selectimpuesto->im_porcentaje?>')">
        ...
        <div class="container-fluid ">
            <div class="row mt-5 mb-4">
                ...
                <div class="col-sm-12 col-md-8"><button class="btn btn-oblong btn-success modal-effect"
                        data-effect="effect-just-me" onclick="sendVenta()" id="btnCrearVenta" style="width:100%;">Enviar</button></div>
            </div>
        </div>
    </div>
    <style>
