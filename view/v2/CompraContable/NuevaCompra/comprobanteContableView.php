    ...
    <div class="br-section-wrapper">
            ...
            <div class="row mg-b-25">
                <div class="col-sm-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="Sucursal" value="<?=$sucursal->razon_social?>"
                ...
                <div class="col-sm-11 col-lg-5">
                    <div class="form-group">
                        ...
                        <input class="form-control codigo_contable" type="text" name="proveedor" value="" id="proveedor"
                            onclick="autocomplete()" placeholder="Ingresa el Tercero" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-placeholder="" id="detalleComprobante"
                            name="comprobante">
                            <option value="0" selected>Agrega un comprobante</option>
                            <?php foreach ($comprobantes as $comprobantes) {?>
                            <option value="<?=$comprobantes->iddetalle_documento_sucursal?>">
                                <b><?=$comprobantes->nombre.": </b>".$comprobantes->ultima_serie."-".zero_fill($comprobantes->ultimo_numero+1, 8)?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
                ...
                <div class="col-sm-12 col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-placeholder="Choose Browser" id="formaPago"
                            name="formaPago">
                ...
                <div class="col-sm-12 col-lg-4">
                    ...
                    <div class="wd-200 mg-b-30">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control fc-datepicker" name="start_date"
                ...
                <div class="col-sm-12 col-lg-4" id="fecha_final">
                    ...
                    <div class="wd-200">
                        <div class="input-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control fc-datepicker" name="end_date"
                ...
                <div class="col-sm-11 col-lg-5" id="factura_proveedor">
                    <div class="form-group">
                        <label class="form-control-label">Factura del proveedor: <span
                                class="tx-danger">*</span></label>
                        <input class="form-control" type="text" name="factura_proveedor"
        ...
        <div class="card shadow p-1 bg-white rounded">
            ...
            <table class="table" id="ItemsToAdd">
                ...
                <tbody>
                    <tr>
                        <td><input class="form-control <?=$autocomplete?>" type="text" name="<?=$autocomplete?>"
                                value="" id="<?=$autocomplete?>" placeholder="Producto"></td>
                        <td>
                            <input type="hidden"
                        ...
                        <td><input class="form-control calculate" type="text" name="costo_producto" id="costo_producto">
                        </td>
                        <!-- <td><input class="form-control calculate" type="text" name="imp_compra" id="imp_compra"></td> -->
                        <td>
                            <div class="input-append btn-group">
                                <input class="span2 form-control calculate" name="imp_compra" id="imp_compra"
                                    type="text" readonly>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <p class="dropdown-item change_tax" style="margin:0"
                                        onclick="changeTax('imp_compra','<?=$selectimpuesto->im_porcentaje?>')">
                                        <?=$selectimpuesto->im_nombre?> (<?=$selectimpuesto->im_porcentaje?>%)</p>
                                    <?php }?>
                                </div>
                            </div>
                        </td>
        ...
        <div class="row mt-5">
            ...
            <!--col-sm-8-->
            <div class="col-sm-3 "><select class="form-control select2re" data-placeholder="Choose Browser"
                    name="retenciones">
            ...
            <!--col-sm-3-->
            <div class="col-sm-1 mt-3"><i id="AddRet" class="fas fa-plus-circle text-success"
            ...
            <!--col-sm-3-->
            <div class="col-sm-1 mt-4"><i id="AddIm" class="fas fa-plus-circle text-success"
                    style="font-size:20pt; line-height:10px; cursor:pointer;"></i></div>
            <!--col-sm-1-->
        ...
        <div class="container-fluid ">
            <div class="row mt-5 mb-4">
                <div class="col-sm-12 col-md-4"><a href="#compras/reg_compras" class="btn btn-oblong btn-outline-danger"
                        style="width:100%;">Regresar</a></div>
                <div class="col-sm-12 col-md-8"><button class="btn btn-oblong btn-success" id="sendCompra"
                        style="width:100%;">Registrar Compra</button></div>
            </div>
        </div>
    </div>
